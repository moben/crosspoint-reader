// from https://github.com/emmaneugene/pi-mono/commit/76323200255e95bdf8b581fd259dc7751563160f
...
export default function questionnaire(pi: ExtensionAPI) {
	pi.registerTool({
		...
		label: "Questionnaire",
		description:
			"Ask the user one or more questions. Always use for asking any questions, clarifying requirements, getting preferences, or confirming decisions. For single questions, shows a simple option list. For multiple questions, shows a tab-based interface.",
